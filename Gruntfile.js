  ...
  grunt.initConfig({
    ...
    env: {
      ...
      prod: {
        ...
        PUBLIC_HOST: process.env.PUBLIC_HOST || 'lelylan.github.io/types-dashboard-ng',
    ...
    copy: {
      dist: {
        files: [{
          ...
          expand: true, cwd: '<%= yeoman.app %>/bower_components/type-directive-ng/dist/', src: ['fonts/*/**'], dest: '<%= yeoman.dist %>/styles'
        }]
      },
      styles: {
        expand: true,
      ...
      dist: {
        ...
        options: {
          replacements: [{
            ...
            pattern: /0f132c8b234ce0018ae0a77d8e9f06126e140885ba86d83f41a168a2aacda7da/g,
    ...
    buildcontrol: {
      ...
      pages: {
        options: {
          remote: 'git@github.com:lelylan/types-dashboard-ng.git',
          branch: 'gh-pages'
        }
      }
    },
